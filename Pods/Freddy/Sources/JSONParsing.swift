...
extension JSONSerialization: JSONParserType {
    ...
    fileprivate static func makeJSON(with object: Any) -> JSON {
        switch object {
    ...
    fileprivate static func makeJSONArray(_ jsonArray: [Any]) -> JSON {
    ...
    fileprivate static func makeJSONDictionary(_ jsonDict: [Swift.String: Any]) -> JSON {
